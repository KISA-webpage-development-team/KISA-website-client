  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn(
          "!bg-gray-300 text-black font-bold rounded-md",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-gray-100 data-[selected-single=true]:text-michigan-light-blue",
        "data-[range-middle=true]:bg-accent data-[range-middle=true]:text-black",
        `data-[range-start=true]:text-michigan-light-blue `,
        "data-[range-end=true]:text-michigan-light-blue",
