...
import { housingOffCampusData } from "@/features/info-page/data/detailPageData";
import "../../../info.css";

export default function OffCampusDetail() {
  return (
    <section className="detail_section">
      {housingOffCampusData.map(({ id, title, desc }, _) => (
