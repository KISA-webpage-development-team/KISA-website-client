...
import { restaurantsFineDiningData } from "@/features/info-page/data/detailPageData";
import "../../../info.css";

export default function FineDiningRestaurantsPage() {
  return (
    <section className="detail_section">
      {restaurantsFineDiningData.map(({ id, title, desc }, _) => (
