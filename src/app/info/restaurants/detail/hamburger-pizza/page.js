...
import { restaurantsHamburgerPizzaData } from "@/features/info-page/data/detailPageData";
import "../../../info.css";

export default function HamburgerPizzaRestaurantsPage() {
  return (
    <section className="detail_section">
      {restaurantsHamburgerPizzaData.map(({ id, title, desc }, _) => (
