...
import type { InfoOverviewData, InfoSection } from "@/features/info-page/components/InfoOverviewTemplate";
...
const centralSection: InfoSection = {
  ...
  contentList: [
    ...
    { id: "kinesiology_building", title: "School of Kinesiology Building\n(SKB)" },
    ...
    { id: "north_university_building", title: "North University Building\n(NUB)" },
  ],
};
...
const northSection: InfoSection = {
  ...
  contentList: [
    ...
    { id: "dow_engineering_building", title: "DOW Engineering Building\n(DOW)" },
    { id: "bob_and_betty_beyster_building", title: "Bob and Betty Beyster Building\n(BBB)" },
    { id: "george_g_brown_laboratories", title: "George G.Brown Laboratories\n(GGBL)" },
    {
      id: "electrical_engineering_and_computer_science_building",
      title: "Electrical Engineering And Computer Science Building\n(EECS)",
    },
    { id: "ford_motor_company_robotics_building", title: "Ford Motor Company Robotics Building\n(FMCRB)" },
    {
      id: "industrial_and_operations_engineering_building",
      title: "Industrial and Operations Engineering building\n(IOE)",
    },
    { id: "earl_v_moore_building", title: "Earl V. Moore Building, School of Music\n(SM)" },
  ],
};
...
const overview: InfoOverviewData = {
  ...
  infoTitle: "Campus",
  pageIntro: [
    "재학생들은 대부분 캠퍼스 내의 빌딩을 풀네임보다는 줄여서 부르거나 이니셜로 부릅니다. 수강 신청 후 Wolverine Access 에서 볼 수 있는 시간표에서도 마찬가지로 이니셜을 확인하실 수 있습니다.",
    "아래에서 각 빌딩의 줄임말 혹은 이니셜과 더불어 빌딩 정보를 확인하실 수 있습니다.",
  ],
